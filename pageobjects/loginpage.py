...
class login:
    ...
    sub_name_select_xpath = "//*[contains(text(),'Paul')]"
    ...
    user_name_txt_xpath = "//div[1]/div/div[1]/div/div[2]/input[@class='oxd-input oxd-input--active']"
    ...
    def add_user(self,emp_name,user_name,pass_word,conf_pass,add_username):
        ...
        time.sleep(2)
    customer_xpath  = "//div[@class='oxd-table-card']//div//div[2]"
    def check_customer_added(self):
        return self.driver.find_element(By.XPATH,self.customer_xpath).text
